    ...
    return (
        <div>
            <div className={`${show ? "" : "hidden"} my-20 py-10 bg-[#e3fcca] w-[90%] md:w-[500px] mx-auto rounded-md`}>
                ...
                <form onSubmit={userUpdate} className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96 mx-auto">
            ...
            <div className={`${show ? "hidden" : ""} my-32 text-center`}>
                <h1 className='text-3xl py-3 font-bold text-[#60AA2D] '>Your profile has been successfully updated!</h1>
                <Link to="/" className='font-bold underline'>Go Back Home</Link>
            </div>
        </div>
    );
};
